    ...
    return(
        <body>
            ...
            <div className="content">
                ...
                <ProjectCard title="Resume - website" image={resume} description="The resume site where you read it. I hope the font is readable enough :)" technologies="JS, React, SCSS" links={['https://github.com/stonislaff/MyResume']}/>
            </div>
        </body>
    )
}
